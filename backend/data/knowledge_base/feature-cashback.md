...
- 1% cashback on select categories:
  ...
  - Gas stations
- No cashback on other purchase categories

### Premium Account
- 2% cashback on all purchases, regardless of category
...
Cashback is earned on:
- In-store purchases (tap, chip, or swipe)
- Online purchases
...
View your complete cashback history: Transactions > Filter > Cashback. See:
