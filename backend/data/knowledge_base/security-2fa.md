...
3. **Biometric authentication:** Use Face ID or fingerprint on supported devices. This is the most convenient method for mobile users.
...
- Adding a new linked bank account
- Sending transfers over $1,000
...
2. Once logged in, go to Settings > Security > 2FA to reset your method
3. If you don't have backup codes, contact support for identity verification and account recovery (takes 1-3 business days)

## Disabling 2FA

We strongly recommend keeping 2FA enabled. If you choose to disable it: Settings > Security > 2FA > Disable. You'll need to verify your identity before 2FA is removed.
